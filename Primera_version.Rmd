...
grafico1 %>%
  ggplot() + 
  geom_col(aes(x = Edad, y = porcentaje_sedentarios/4), fill = "#FFEC8B", color = "black") + 
  geom_borderline(data = grafico1_H, aes(x = Edad, y = porcentaje_audifonos), linewidth = 1.2, color = "#9400D3", bordercolor = "black", group = 1) +
  geom_borderline(data = grafico1_M, aes(x = Edad, y = porcentaje_audifonos), linewidth = 1.2, color = "cyan", bordercolor = "black",group = 1) + 
...
grafico2 %>%
  ggplot() + 
  geom_col(aes(x = Edad, y = porcentaje_sedentarios/4), fill = "#FFEC8B", color = "black") + 
  geom_borderline(data = grafico2_H, aes(x = Edad, y = porcentaje_gafas), linewidth = 1.2, color = "#9400D3", bordercolor = "black", group = 1) +
  geom_borderline(data = grafico2_M, aes(x = Edad, y = porcentaje_gafas), linewidth = 1.2, color = "cyan", bordercolor = "black",group = 1) + 
  scale_y_continuous(sec.axis = sec_axis(~., name = "Porcentaje Uso gafas (%)")) +
  guides(x = guide_axis(angle =45)) +
  facet_wrap(facets = vars(Sexo), nrow = 1) +
  labs(x= "Grupos de edad", y = "Porcentaje sedentarismo (%)") +
  ...
  dark_theme_gray() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank())
```
