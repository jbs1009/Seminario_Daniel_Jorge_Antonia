...
```{r}
conjunto_ejemplo_sedentarismo <- fromJSON(file = )
conjunto_ejemplo_imc <- fromJSON(file = )
conjunto_ejemplo_gafas <- fromJSON(file = )
conjunto_ejemplo_audifonos <- fromJSON(file =)
```
