...
grafico1 %>%
  ggplot() + 
  geom_col(aes(x = Edad, y = porcentaje_sedentarios/4), fill = "#FFEC8B", color = "black") + geom_borderline(data = grafico1_H, aes(x = Edad, y = porcentaje_audifonos), linewidth = 1.2, color = "#9400D3", bordercolor = "black", group = 1) +
  geom_borderline(data = grafico1_M, aes(x = Edad, y = porcentaje_audifonos), linewidth = 1.2, color = "cyan", bordercolor = "black",group = 1) + scale_y_continuous(sec.axis = sec_axis(~., name = "Porcentaje Uso audífonos (%)")) 
```
